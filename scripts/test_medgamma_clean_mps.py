#!/usr/bin/env python3
"""
MedGamma1.5-4B-it Testing Script (Apple GPU / MPS)
"""
...
print("=" * 70)
print("MedGamma1.5-4B-it Testing Script (MPS)")
print("=" * 70)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="MedGamma One-Click Test (MPS)")
